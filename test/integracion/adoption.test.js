...
describe("Test Adoption Integration Module", () => {
    ...
    it("[POST] /api/adoptions - Create Adoption", async () => {
        const newAdoption = {
            owner: "67ea8eb96bbafdc7e0451fa2",
            pet: "67ea8cc46bbafdc7e0451f35",
        };
        ...
        expect(body.owner).to.be.property("67ea8eb96bbafdc7e0451fa2");
        expect(body.pet).to.be.property("67ea8cc46bbafdc7e0451f35");
    ...
    it("[GET] /api/adoptions/:id - Get one Adoption", async () => {
        ...
        expect(body.owner).to.be.equal("67ea8eb96bbafdc7e0451fa2");
        expect(body.pet).to.be.equal("67ea8cc46bbafdc7e0451f35");
    });
